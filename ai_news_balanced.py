    ...
    with sync_playwright() as p:
        ...
        for source in sources:
            ...
            try:
                ...
                collected = 0
                for link in links:
                    if collected >= 3 or len(news_items) >= 12:
                        break
...
def main():
    """主函数"""
    print("=" * 60)
    print("AI 资讯快报 - 快速人类模拟版")
    print("=" * 60)
    print()
    
    # [1/2] 抓取新闻
    print("[1/2] 抓取最新 AI 资讯（模拟人类行为，约 1-2 分钟）...")
    start_time = time.time()
    news_items = fetch_news_fast_human()
