...
> 📰 自动抓取 10+ 科技媒体最新 AI 新闻，一键生成小红书风格图片，自动发布。每天节省 2-3 小时找素材时间。
...
- [docs/01-安装指南.md](docs/01-安装指南.md) - 环境准备与依赖安装
- [docs/02-配置说明.md](docs/02-配置说明.md) - 个性化配置教程
- [docs/03-常见问题.md](docs/03-常见问题.md) - FAQ 与故障排除
